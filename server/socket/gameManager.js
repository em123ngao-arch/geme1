...
class GameManager {
    ...
    createMatch(p1, p2, mode) {
        ...
        const topics = ['Lịch Sử Toàn Thư', 'Khám phá Vũ trụ', 'Khoa học Lượng tử', 'Thể Thao Đỉnh Cao', 'Địa Lý Thú Vị', 'Văn Học Nghệ Thuật'];
        ...
        if (mode === 1 || mode === 2) {
            // Background generation instantly when they enter room
